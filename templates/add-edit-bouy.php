...
/*record date*/
 ...
 if($_POST['submit']=='Update'){
             ...
             // Update the post into the database
              ...
              $qry_content_update = "update content_type_buoy SET field_buoy_location_value='".$_POST['field_buoy_location_value']."',
        field_bouy_site_active_status_value='".$_POST['field_bouy_site_active_status_value']."',

        field_site_id_value='".$_POST['field_site_id_value']."',
        field_organization_value ='".$_POST['field_organization_value']."',
        field_official_number_value ='".$_POST['field_official_number_value']."',

        field_official_number_value='".$_POST['field_official_number_value']."',
        field_nation_value='".$_POST['field_nation_value']."',
        field_built_year_value='".$_POST['field_built_year_value']."',
        field_built_location_value='".$_POST['field_built_location_value']."',
        field_built_by_value='".$_POST['field_built_by_value']."',
        field_wreck_type_value='".$_POST['field_wreck_type_value']."',
        field_rig_value='".$_POST['field_rig_value']."',
        field_length_value='".$_POST['field_length_value']."',
        field_beam_value='".$_POST['field_beam_value']."',
        field_draft_value='".$_POST['field_draft_value']."',
        field_tonnage_value='".$_POST['field_tonnage_value']."',
        field_buoy_description_value='".$_POST['field_buoy_description_value']."',
        field_tonnage_value='".$_POST['field_tonnage_value']."',
        field_buoy_material_value='".$_POST['field_buoy_material_value']."',
        field_bodywater_value='".$_POST['field_bodywater_value']."',
        field_latitude_value='".$_POST['field_latitude_value']."',
        field_longitude_value='".$_POST['field_longitude_value']."',
        field_longitude_value='".$_POST['field_longitude_value']."',
        field_longitude_value='".$_POST['field_longitude_value']."',
        field_current_value='".$_POST['field_current_value']."',
        field_buoy_type_value='".$_POST['field_buoy_type_value']."',
        field_line_type_value='".$_POST['field_line_type_value']."',
        field_line_size_value='".$_POST['field_line_size_value']."',
        field_line_length_value='".$_POST['field_line_length_value']."',
        field_anchor_type_value='".$_POST['field_anchor_type_value']."',
        field_anchor_weight_value='".$_POST['field_anchor_weight_value']."',
        field_depth_max_value='".$_POST['field_depth_max_value']."',
        field_depth_min_value='".$_POST['field_depth_min_value']."',
        field_buoy_notess_value='".$_POST['field_buoy_notess_value']."',
        field_plaque_value='".$_POST['field_plaque_value']."' where vid='".$vid."'";
...
<form action="<?php bloginfo('url'); ?>/buoy-program/buoy-site-list/edit/?id=<?php echo $postid;  ?>" accept-charset="UTF-8" method="post" id="node-form" enctype="multipart/form-data" class="custom-form">
<div>
<div class="node-form form-block">
  <div class="standard">
<div class="form-item" id="edit-title-wrapper">


 <label for="edit-title">Site Name: <span class="form-required" title="This field is required.">*</span></label>
 <input maxlength="255" name="title" id="edit-title" size="60" value="<?php the_title(); ?>" class="form-text required" type="text">
...
<div class="form-item" id="edit-field-bouy-site-active-status-value-wrapper">
 ...
 <div class="description">Check "Yes" if the Bouy Site is active.</div>
</div>

<div class="form-item" id="edit-field-site-id-0-value-wrapper">
 <label for="edit-field-site-id-0-value">Site ID: </label>
 <input maxlength="10" name="field_site_id_value" id="edit-field-site-id-0-value" size="12" value="<?php echo $field_site_id_value; ?>" class="form-text number" type="text">
</div>
...
<input name="form_id" id="edit-buoy-node-form" value="buoy_node_form" type="hidden">

<div class="form-item" id="edit-field-organization-value-wrapper">
 <label for="edit-field-organization-value">Organization: </label>
 <select name="field_organization_value" class="form-select" id="edit-field-organization-value">
<option value="" >- None -</option>
<option value="68" <?php if($field_organization_value=='68'){ echo 'selected'; } ?>>ErieQuest</option>
<option value="66" <?php if($field_organization_value=='66'){ echo 'selected'; } ?>>Niagara Divers Assn</option>
<option value="67" <?php if($field_organization_value=='67'){ echo 'selected'; } ?>>Preserve Our Wrecks</option>
<option value="269" <?php if($field_organization_value=='269'){ echo 'selected'; } ?>>Durham/Northumberland</option>
<option value="246" <?php if($field_organization_value=='246'){ echo 'selected'; } ?>>SOS Barrie</option>
<option value="69" <?php if($field_organization_value=='69'){ echo 'selected'; } ?>>SOS Hamilton</option>
<option value="64" <?php if($field_organization_value=='64'){ echo 'selected'; } ?>>SOS Huron Shores</option>
<option value="72" <?php if($field_organization_value=='72'){ echo 'selected'; } ?>>SOS Manitoulin</option>
<option value="61" <?php if($field_organization_value=='61'){ echo 'selected'; } ?>>SOS Ottawa</option>
<option value="71"<?php if($field_organization_value=='71'){ echo 'selected'; } ?> >SOS Port Dover</option>
<option value="73" <?php if($field_organization_value=='73'){ echo 'selected'; } ?>>SOS Quebec</option>
<option value="267" <?php if($field_organization_value=='267'){ echo 'selected'; } ?>>SOS Superior</option>
<option value="62" <?php if($field_organization_value=='62'){ echo 'selected'; } ?>>SOS Thousand Islands</option>
<option value="63" <?php if($field_organization_value=='63'){ echo 'selected'; } ?>>SOS Toronto</option>
<option value="70" <?php if($field_organization_value=='70'){ echo 'selected'; } ?>>SOS Windsor</option>
</select>
</div>
<div class="container-inline-date date-clear-block"><div class="form-item" id="edit-field-record-date-0-value-wrapper">
 ...
 <label for="edit-field-record-date-0-value-month">Month: </label>
 <select name="field_record_date_month" class="form-select  date-month" id="edit-field-record-date-0-value-month">
 	<option value="" selected="selected"></option>
 	<option value="1" <?php if($mrecord=='1'){ echo  'selected'; }  ?>>Jan</option>

 	<option value="2" <?php if($mrecord=='2'){ echo  'selected'; }  ?>>Feb</option>
 	<option value="3" <?php if($mrecord=='3'){ echo  'selected'; }  ?>>Mar</option>
 	<option value="4" <?php if($mrecord=='4'){ echo  'selected'; }  ?>>Apr</option>
 	<option value="5" <?php if($mrecord=='5'){ echo  'selected'; }  ?>>May</option>
 	<option value="6" <?php if($mrecord=='6'){ echo  'selected'; }  ?>>Jun</option>
 	<option value="7" <?php if($mrecord=='7'){ echo  'selected'; }  ?>>Jul</option>
 	<option value="8" <?php if($mrecord=='8'){ echo  'selected'; }  ?>>Aug</option>
 	<option value="9" <?php if($mrecord=='9'){ echo  'selected'; }  ?>>Sep</option>
 	<option value="10" <?php if($mrecord=='10'){ echo  'selected'; }  ?>>Oct</option>
 	<option value="11" <?php if($mrecord=='11'){ echo  'selected'; }  ?>>Nov</option>
 	<option value="12" <?php if($mrecord=='12'){ echo  'selected'; }  ?>>Dec</option>

 </select>
</div>
</div><div class="date-day"><div class="form-item" id="edit-field-record-date-0-value-day-wrapper">
 <label for="edit-field-record-date-0-value-day">Day: </label>
 <select name="field_record_date_day" class="form-select  date-day" id="edit-field-record-date-0-value-day"><option value="" selected="selected"></option>
 	<option value="1" <?php if($drecord=='1'){ echo  'selected'; }  ?>>1</option>
 	<option value="2" <?php if($drecord=='2'){ echo  'selected'; }  ?>>2</option>
 	<option value="3" <?php if($drecord=='3'){ echo  'selected'; }  ?>>3</option>
 	<option value="4" <?php if($drecord=='4'){ echo  'selected'; }  ?>>4</option>
 	<option value="5" <?php if($drecord=='5'){ echo  'selected'; }  ?>>5</option>
 	<option value="6" <?php if($drecord=='6'){ echo  'selected'; }  ?>>6</option>
 	<option value="7" <?php if($drecord=='7'){ echo  'selected'; }  ?>>7</option>
 	<option value="8" <?php if($drecord=='8'){ echo  'selected'; }  ?>>8</option>
 	<option value="9" <?php if($drecord=='9'){ echo  'selected'; }  ?>>9</option>
 	<option value="10" <?php if($drecord=='10'){ echo  'selected'; }  ?>>10</option>
 	<option value="11" <?php if($drecord=='11'){ echo  'selected'; }  ?>>11</option>
 	<option value="12" <?php if($drecord=='12'){ echo  'selected'; }  ?>>12</option>
 	<option value="13" <?php if($drecord=='13'){ echo  'selected'; }  ?>>13</option>
 	<option value="14" <?php if($drecord=='14'){ echo  'selected'; }  ?>>14</option>
 	<option value="15" <?php if($drecord=='15'){ echo  'selected'; }  ?>>15</option>
 	<option value="16" <?php if($drecord=='16'){ echo  'selected'; }  ?>>16</option>
 	<option value="17" <?php if($drecord=='17'){ echo  'selected'; }  ?>>17</option>
 	<option value="18" <?php if($drecord=='18'){ echo  'selected'; }  ?>>18</option>
 	<option value="19" <?php if($drecord=='19'){ echo  'selected'; }  ?>>19</option>
 	<option value="20" <?php if($drecord=='20'){ echo  'selected'; }  ?>>20</option>
 	<option value="21" <?php if($drecord=='21'){ echo  'selected'; }  ?>>21</option>
 	<option value="22" <?php if($drecord=='22'){ echo  'selected'; }  ?>>22</option>
 	<option value="23" <?php if($drecord=='23'){ echo  'selected'; }  ?>>23</option>
 	<option value="24" <?php if($drecord=='24'){ echo  'selected'; }  ?>>24</option>
 	<option value="25" <?php if($drecord=='25'){ echo  'selected'; }  ?>>25</option>
 	<option value="26" <?php if($drecord=='26'){ echo  'selected'; }  ?>>26</option>
 	<option value="27" <?php if($drecord=='27'){ echo  'selected'; }  ?>>27</option>
 	<option value="28" <?php if($drecord=='28'){ echo  'selected'; }  ?>>28</option>
 	<option value="29" <?php if($drecord=='29'){ echo  'selected'; }  ?>>29</option>
 	<option value="30" <?php if($drecord=='30'){ echo  'selected'; }  ?>>30</option>
 	<option value="31" <?php if($drecord=='31'){ echo  'selected'; }  ?>>31</option>
 </select>
</div>
</div><div class="date-year"><div class="form-item" id="edit-field-record-date-0-value-year-wrapper">
 <label for="edit-field-record-date-0-value-year">Year: </label>
 <select name="field_record_date_year" class="form-select  date-year" id="edit-field-record-date-0-value-year">
 	<option value="" ></option>
    <option value="2002" <?php if($yrecord=='2002'){ echo  'selected'; }  ?>>2002</option>
    <option value="2003" <?php if($yrecord=='2003'){ echo  'selected'; }  ?>>2003</option>
    <option value="2004" <?php if($yrecord=='2004'){ echo  'selected'; }  ?>>2004</option>
    <option value="2005" <?php if($yrecord=='2005'){ echo  'selected'; }  ?>>2005</option>
    <option value="2006" <?php if($yrecord=='2006'){ echo  'selected'; }  ?>>2006</option>
    <option value="2007" <?php if($yrecord=='2007'){ echo  'selected'; }  ?>>2007</option>
    <option value="2008" <?php if($yrecord=='2008'){ echo  'selected'; }  ?>>2008</option>s
 	<option value="2008" <?php if($yrecord=='2008'){ echo  'selected'; }  ?>>2008</option>
 	<option value="2009" <?php if($yrecord=='2009'){ echo  'selected'; }  ?>>2009</option>
 	<option value="2010" <?php if($yrecord=='2010'){ echo  'selected'; }  ?>>2010</option>
 	<option value="2011" <?php if($yrecord=='2011'){ echo  'selected'; }  ?>>2011</option>
 	<option value="2012" <?php if($yrecord=='2012'){ echo  'selected'; }  ?>>2012</option>
 	<option value="2013" <?php if($yrecord=='2013'){ echo  'selected'; }  ?>>2013</option>
 	<option value="2014" <?php if($yrecord=='2014'){ echo  'selected'; }  ?>>2014</option>
 	<option value="2015" <?php if($yrecord=='2015'){ echo  'selected'; }  ?>>2015</option>
 	<option value="2016" <?php if($yrecord=='2016'){ echo  'selected'; }  ?>>2016</option>
 	<option value="2017" <?php if($yrecord=='2017'){ echo  'selected'; }  ?>>2017</option>
 	<option value="2018" <?php if($yrecord=='2018'){ echo  'selected'; }  ?>>2018</option>
 </select>
</div>
</div>
</div>
 ...
 <input name="field_official_number_value" id="edit-field-official-number-0-value" size="60" value="<?php echo $field_official_number_value;?>" class="form-text text" type="text">
</div>
...
<?php endif; ?>
			...
			<div class="col-md-4 col-sm-5 about-single-sidebar">
				...
				<div class="side-links">
					<ul>
						<li><a href="#">NAS Training</a></li>
						<li class="submenu">
							<a href="#">Buoy Program</a>
							<ul>
								<li><a href="#">Buoy Program Overview</a></li>
								<li><a href="#">Buoy Site List</a></li>
								<li><a href="#">Buoy Status Updates</a></li>
								<li><a href="#">Buoy Requirements & Responsibilities</a></li>
							</ul>
						</li>
						<li class="submenu">
						...
						<li><a href="#">Shipwreck Geek Trivia</a></li>
					</ul>
				</div>
				<h3 class="heading">Donate to sos</h3>
				<div class="volunteer">
					<h4>Wanna be a<br>Volunteer?</h4>
					<img src="images/icon-volunteer.png" class="center-block img-responsive" alt=""/>
					<a href="#" class="bttn bttn-white">Join Us Now!</a>
				</div>
			</div>
		</div>
	</div>
