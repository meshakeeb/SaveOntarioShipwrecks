...
class BoltMedia 
{
    ...
    function create_roles() 
    {
        ...
        //cleanup first 
        //if (get_role('bolt_chapter_editor')) remove_role('bolt_chapter_editor');
        //if (get_role('bolt_chapter_member')) remove_role('bolt_chapter_member');
        add_role(
            'bolt_chapter_editor', 
            'Chapter Editor*',  
            array(
    ...
    ************************/
    ...
    /***********************
    RETRIEVE "CHAPTER POST TYPES"
    ************************/
    public static function chapter_list() {
