...
class BoltMediaFront {
    ...
    ************************/
    ...
    public static function get_dashboard_profile($user_info)
    {
        ...
        global $wpdb;
        $date =  $wpdb->get_row("SELECT `expiration_date` FROM `sos807_pms_member_subscriptions` WHERE `user_id`= $user_info->ID", OBJECT);
    ...
    public static function RenewalLink()
    {
        ...
        $query = "SELECT id FROM sos807_pms_member_subscriptions WHERE user_id = ".get_current_user_id()."";
