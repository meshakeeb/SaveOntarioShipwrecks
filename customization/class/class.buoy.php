...
class BoltMediaBuoy {
    ...
    public static function GetBuoys($query_string = null){
        ...
        $query = "SELECT 
                    ...
                    FROM sos807_posts AS A
                    

                        LEFT JOIN sos807_postmeta AS B ON  A.ID = B.post_id AND  B.meta_key = 'vid'
                        ...
                        LEFT JOIN sos807_postmeta AS G ON A.ID = G.meta_value AND G.meta_key = 'site_name'
                        LEFT JOIN sos807_postmeta AS H ON G.post_id = H.post_id AND H.meta_key = 'buoy_status' 
                        LEFT JOIN sos807_posts AS I ON G.post_id = I.ID AND I.post_type = 'buoystatus1' AND I.post_name = A.post_name
