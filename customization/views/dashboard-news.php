...
<?php /* <pre><?php print_r( $user_info ); ?></pre> */ ?>
<form method="post" id="add_news">

        <p><input type="text" name="post_title" value="" class="form-control" placeholder="Content Title"></p>

        <p><span id="j_photo" style="display:block"></span></p>
...
<script>
    ...
    jQuery(document).ready( function($) {
        ...
        //attachment
        jQuery(".attachmentUpload").live( "click", function () {
        uploadID = jQuery(this).prev('input');
        var formfield = jQuery('#upload_image').attr('name');
        tb_show('', '<?php echo get_site_url(); ?>/wp-admin/media-upload.php?type=image&amp;TB_iframe=true');
        return false;
      ...
      window.send_to_editor = function(html) {
        ...
        if ( imgurl ){
          ...
          var whatDiv = uploadID.attr('class');
          AppendImage(imgurl, whatDiv );
        }
